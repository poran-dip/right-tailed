      ...
      >
        <div className="flex flex-col h-full p-6 overflow-y-auto">
          ...
          <div className="pt-6 mt-6 border-t border-slate-200 dark:border-neutral-700">
            ...
            <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-700 dark:text-slate-300 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20">
